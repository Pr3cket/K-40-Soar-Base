...
public class LayerBendsCustomHead implements LayerRenderer<EntityLivingBase> {
    ...
    public void doRenderLayer(EntityLivingBase p_177141_1_, float p_177141_2_, float p_177141_3_, float p_177141_4_,
        ...
        if (itemstack != null && itemstack.getItem() != null) {
            ...
            boolean flag =
                    p_177141_1_ instanceof EntityVillager || p_177141_1_ instanceof EntityZombie && ((EntityZombie) p_177141_1_).isVillager();
            float f7;
            ...
            if (item instanceof ItemBlock) {
                ...
                minecraft.getItemRenderer().renderItem(p_177141_1_, itemstack, TransformType.HEAD);
                ...
                if (itemstack.hasTagCompound()) {
                    ...
                    if (nbttagcompound.hasKey("SkullOwner", 10)) {
                        ...
                        gameprofile = TileEntitySkull.updateGameprofile(new GameProfile(null,
