...
public class Animation_Sprint extends Animation {
    ...
    public void animate(EntityLivingBase argEntity, ModelBase argModel, EntityData argData) {
        ...
        ((ModelRendererBends) model.bipedRightArm).rotation.setSmoothX(1.1F * (float) ((double) (MathHelper.cos(model.armSwing * 0.6662F + 3.1415927F) * 2.0F * model.armSwingAmount * 0.5F) / 3.141592653589793D * 180.0D));
        ((ModelRendererBends) model.bipedLeftArm).rotation.setSmoothX(1.1F * (float) ((double) (MathHelper.cos(model.armSwing * 0.6662F) * 2.0F * model.armSwingAmount * 0.5F) / 3.141592653589793D * 180.0D));
        ...
        ((ModelRendererBends) model.bipedRightLeg).rotation.setSmoothX(-5.0F + 0.9F * (float) ((double) (MathHelper.cos(model.armSwing * 0.6662F) * 1.4F * model.armSwingAmount) / 3.141592653589793D * 180.0D), 1.0F);
        ((ModelRendererBends) model.bipedLeftLeg).rotation.setSmoothX(-5.0F + 0.9F * (float) ((double) (MathHelper.cos(model.armSwing * 0.6662F + 3.1415927F) * 1.4F * model.armSwingAmount) / 3.141592653589793D * 180.0D), 1.0F);
        ...
        float var3 = (float) (Math.cos(model.armSwing * 0.6662F * 2.0F) * 0.5D + 0.5D) * 20.0F;
