...
import com.lawab1ders.nan7i.kali.module.impl.server.occlusionculling.cache.ArrayOcclusionCache;
import com.lawab1ders.nan7i.kali.module.impl.server.occlusionculling.cache.OcclusionCache;
import com.lawab1ders.nan7i.kali.module.impl.server.occlusionculling.util.MathUtilities;
...
public class OcclusionCulling {
    ...
    private int reach = 128;
    private OcclusionCache cache;
    private boolean allowRayChecks = false;
    private boolean allowWallClipping = false;

    public OcclusionCulling(DataProvider provider) {
        this(provider, new ArrayOcclusionCache(128), 0.5);
    }

    public OcclusionCulling(DataProvider provider, OcclusionCache cache, double aabbExpansion) {
    ...
    public void setReach(int maxDistance) {
        this.reach = maxDistance;
        this.cache = new ArrayOcclusionCache(maxDistance);
    }
     ...
     * <a href=
     * "http://playtechs.blogspot.de/2007/03/raytracing-on-grid.html">http://playtechs.blogspot
     * .de/2007/03/raytracing-on-grid.html</a>
     * <p>
